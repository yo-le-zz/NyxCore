...
# Téléchargement et enregistrement officiel de l'extension Util pour WiX v4.0.5
echo "[msi] Installation de l'extension WiX Utilitaire..."
wix extension add WixToolset.Util.Extension/4.0.5

for COMPONENT in client; do
    PKG_NAME="nyxcore-${COMPONENT}"
    
    # Utilisation d'un chemin relatif universel que WiX comprend très bien
    SRC_DIR="dist/${COMPONENT}/main.dist"

    # Génération du fichier source avec le namespace utilitaire officiel v4
...
<Wix xmlns="http://wixtoolset.org/schemas/v4/wxs"
  ...
  <Package Name="NyxCore ${COMPONENT^}" Version="${VERSION}" Manufacturer="yolezz"
    ...
    <ComponentGroup Id="AppFilesGroup">
      <Files Include="${SRC_DIR}/**" Directory="INSTALLDIR" />
    </ComponentGroup>
...
EOF
    ...
    # Compilation avec WiX v4 en liant explicitement l'extension installée
